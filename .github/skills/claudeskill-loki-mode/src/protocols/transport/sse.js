...
class SSETransport {
  constructor(handler, options) {
    ...
    this._corsOrigin =
      options && options.corsOrigin !== undefined
        ? options.corsOrigin
  ...
  start() {
    ...
    this._server.listen(this._port, this._host, () => {
      process.stderr.write("[mcp-sse] Listening on " + this._host + ":" + this._port + "\n");
    });
  }
  ...
  _onRequest(req, res) {
    ...
    res.end(
      JSON.stringify({
        ...
        error: {
          code: -32600,
          message: "Not found. Use POST /mcp, GET /mcp/events, or GET /mcp/health",
        },
        id: null,
      }),
    );
