...
const schema = {
  name: TOOL_NAME,
  description:
    "Get the current project status including RARV cycle state, active agents, and quality gate results.",
  inputSchema: {
    type: "object",
    properties: {
      projectId: {
...
function execute(params) {
  ...
  return {
    success: true,
    projectId:
      (orchestrator && orchestrator.projectId) || (session && session.projectId) || "unknown",
