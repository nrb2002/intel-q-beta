...
var ISO27001_CONTROLS = {
  "A.9.2": {
    ...
    description: "Formal access provisioning and de-provisioning",
  },
  "A.12.4": {
    name: "Logging and Monitoring",
    description: "Events are recorded and evidence is generated",
  },
  "A.12.5": {
    name: "Control of Operational Software",
    description: "Installation of software is controlled",
  },
  "A.14.2": { name: "Security in Development", description: "Security requirements in SDLC" },
  "A.16.1": {
    name: "Incident Management",
    description: "Consistent approach to security incidents",
  },
  "A.18.1": {
    name: "Compliance",
